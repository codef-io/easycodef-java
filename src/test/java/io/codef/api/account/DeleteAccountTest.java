...
public class DeleteAccountTest {
	...
	@Test
	public void deleteAccount() throws UnsupportedEncodingException, JsonProcessingException, InterruptedException {
		/**	
		 * #1.쉬운 코드에프 객체 생성
		 */
		...
		/**	#6.요청	*/
		String result = codef.deleteAccount(EasyCodefServiceType.SANDBOX, parameterMap);
